...
- Any mention of agentic coding or AI tooling must name the tool actually used for that work (Claude Code, Cursor, or Antigravity per CLAUDE.md's Technical Skills), never a hardcoded default
